...
public class GoogleLoginUploadVideo extends BaseActivity {
            ...
            case REQUEST_ACCOUNT_PICKER:
                if (data != null && data.getExtras() != null) {
                    ...
                    if (accountName != null) {
                        ...
                        Intent videoIntent = new Intent(getApplicationContext(), UploadChallengeVideo.class);
                        videoIntent.putExtra("ChallengeID", getIntent().getStringExtra("ChallengeID"));
                        videoIntent.putExtra("ChallengeCatID", getIntent().getStringExtra("ChallengeCatID"));
...
//                        getResultsFromApi();
    ...
    private void handleSignInResult(Task<GoogleSignInAccount> completedTask) {
        try {
            ...
            if (acct != null) {
                ...
                videoIntent.putExtra(GlobalVariable.PREF_ACCOUNT_NAME,acct.getGivenName());
                startActivity(videoIntent);
                finish();
            }
        } catch (Exception e) {
    ...
    private void google_login() {
        if (isNetworkConnected()) {
            Permissions.check(GoogleLoginUploadVideo.this,
